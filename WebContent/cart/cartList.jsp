...
<script src="/jsp-shoppingmall/cart/cartList.js"></script>
...
<c:if test="${count > 0}">
  ...
  <c:forEach var="cart" items="${cartLists}">
    <tr> 
       <td width="300">
         <img src="/jsp-shoppingmall/bookImage/${cart.getBook_image()}" 
    ...
    <tr height="10">
      <td colspan="5" align="center">
         <div id="cinfo">
         <table><tr>
           <td><form id="cartForm" method="post" action="/jsp-shoppingmall/buyForm.do">
            <input type="hidden" name="buyer" value="${sessionScope.id}">
            <input type="submit" value="구매하기">
            </form></td>
           <td><form id="cartClearForm" method="post" action="/jsp-shoppingmall/deleteCart.do">
