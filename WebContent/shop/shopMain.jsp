...
<div id="cata" class="box2">
  <ul>
    <li><a href="/jsp-shoppingmall/list.do?book_kind=100">문학</a>
    <li><a href="/jsp-shoppingmall/list.do?book_kind=200">어학</a>
    <li><a href="/jsp-shoppingmall/list.do?book_kind=300">컴퓨터</a>
    <li><a href="/jsp-shoppingmall/list.do?book_kind=all">전체</a>
  </ul>
</div>
...
<div id="shop" class="box2">
  <c:forEach var="bookList" items="${bookLists}">
    ...
    <p class="b">[${book_kindName}] 분류의 신간목록:<a href="/jsp-shoppingmall/list.do?book_kind=${book_kind}">더보기</a></p>
    <c:forEach var="book" items="${bookList}">
     <table class="vhcenter">
      <tr height="30"> 
        <td rowspan="4"  width="100">
          <a href="/jsp-shoppingmall/bookContent.do?book_id=${book.getBook_id()}&book_kind=${book.getBook_kind()}">
             <img src="/jsp-shoppingmall/bookImage/${book.getBook_image()}" class="listimage"></a></td>
        <td width="350" class="vhcenter">
          <a href="/jsp-shoppingmall/bookContent.do?book_id=${book.getBook_id()}&book_kind=${book.getBook_kind()}" class="b">
