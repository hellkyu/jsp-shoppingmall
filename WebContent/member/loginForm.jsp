...
<script src="/jsp-shoppingmall/member/login.js"></script>
           ...
           <div id="info">
             <table>
               <tr height="10">
                 ...
                 <td><form id="cartForm" method="post" action="/jsp-shoppingmall/cartList.do">
                   <input type="hidden" name="buyer" value="${sessionScope.id}">
                   <input type="submit" name="cart" value="장바구니"></form></td>
                 <td><form id="buyForm" method="post" action="/jsp-shoppingmall/buyList.do">
                   <input type="hidden" name="buyer" value="${sessionScope.id}">
